...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kaveky', // 您的昵称 例如 tangly1024

  BIO: process.env.NEXT_PUBLIC_BIO || '一个压力很大的中年人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kaveky.club', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '成长, 博客，投资， 股票', // 网站关键词 英文逗号隔开
